    ...
    public partial class frmCadPizzas : Form
    {
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (validacao())
            {
                ...
                mensagem = "Tipo da Pizza:" + minhaPizza.getTipo() + "\n";
                mensagem = mensagem + "Sabor da Pizza:" + minhaPizza.getSabor() + "\n";
                mensagem = mensagem + "Composição da Pizza:" + minhaPizza.getComposicao() + "\n";
                mensagem = mensagem + "Permite Borda:" + (minhaPizza.getPermiteBorda() ? "Sim" : "Não") + "\n";
                mensagem = mensagem + "Borda(s):" + minhaPizza.getBordas() + "\n";
                mensagem = mensagem + "Valor da Pizza Pequena:" + minhaPizza.getValorPequena().ToString() + "\n";
                mensagem = mensagem + "Valor da Pizza Família:" + minhaPizza.getValorFamilia().ToString();
